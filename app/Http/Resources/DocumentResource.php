...
class DocumentResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'ai_summaries' => $this->whenLoaded('ai_summaries', fn() => AiSummaryResource::collection($this->ai_summaries), []),
            'ai_voices' => $this->whenLoaded('ai_voices', fn() => AiVoiceResource::collection($this->ai_voices), []),
            'chatbot_questions' => $this->whenLoaded('chatbot_questions', fn() => ChatbotQuestionResource::collection($this->chatbot_questions), []),
